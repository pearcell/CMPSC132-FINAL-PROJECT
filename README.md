...
Execute the program in your CLI or IDE. In the terminal, you will be prompted with all of the following executable commands. 

  1. Type 'exit' to terminate program
  2. Type 'run' to run webscraper/fetch laptop data
  3. Type 'search' to search by price

After typing 'search' the user will be prompted to enter a price in the form of a non-negative number.
